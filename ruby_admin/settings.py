"""
Django settings for ruby_admin project.
...
ALLOWED_HOSTS = ['https://ruby-ai-admin.azurewebsites.net']
...
WSGI_APPLICATION = 'ruby_admin.wsgi.application'
